...
func (UnimplementedPostsServerServer) CreatePost(context.Context, *CreateRequest) (*CreateResponse, error) {
...
var PostsServer_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "posts_proto/posts.proto",
}
