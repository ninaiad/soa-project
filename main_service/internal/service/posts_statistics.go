...
func CreateKafkaService(kafkaProducer *kafka.Producer, cfg KafkaConfig, eventCh chan kafka.Event) *KafkaService {
	return &KafkaService{producer: kafkaProducer, cfg: cfg, eventCh: eventCh}
}
